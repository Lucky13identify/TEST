 ...
 *
 * название с большой буквы и существительной в единственном числе
 */
...
// свойство protototype есть только у функции-конструтора и туда мы добавляем новые функции допполнительныее
//  которые будут ссылаться на функцию-конструктор
// хранят всефункции и методы в прототипах чтобы былаа ссылка и переиспользование
// если просто создать метод внутри функции-конструктор, то будет просто каждый раз новая копия
